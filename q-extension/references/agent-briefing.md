...
- **Conform to the structure**: the section heading, the groups in the order they run here, one line per doc, or the single line `- none yet` in a Specs or Guides group with no docs. Name each group for what it actually holds.
